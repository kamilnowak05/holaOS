...
export const AUTH_BASE_URL = "https://api.imerchstaging.com";
export const AUTH_SIGN_IN_URL = "https://app.imerchstaging.com/signin";
export const AUTH_PROTOCOL_SCHEME = "ai.holaboss.app";
export const DEFAULT_MODEL_PROXY_BASE_URL = "http://127.0.0.1:3060/api/v1/model-proxy";
export const DEFAULT_RUNTIME_MODEL = "openai/gpt-5.1";
